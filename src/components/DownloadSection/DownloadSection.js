...
const DownloadSection = () => {
    ...
    <section className="download-section-wrapper">
        ...
        <div className="card-wrapper">
            <div className="card1">
            <DownloadCard
                browserSvg={chromeLogo} 
                browserTitle="Add to Chrome"
                browserDescription="Minimum version 62" />
            </div>
            <div className="card2">
            <DownloadCard
                browserSvg={firefoxLogo} 
                browserTitle="Add to Firefox"
                browserDescription="Minimum version 55" />
            </div>
            <div className="card3">
            <DownloadCard
                browserSvg={operaLogo} 
                browserTitle="Add to Opera"
                browserDescription="Minimum version 46" />
            </div>
        </div>
    </section>
    );
