        ...
        <div className="popup-wrapper">
            <div className="popup-window">
                ...
                <div className="popup-content-wrapper">
                    <div className="popup-illustration-wrapper">
                        <div className="blue-shape-popup" />
                        <div className="popup-illustration">{popupIllustration}</div>
                    </div>
                    <div className="popup-text-column">
                        <h6 className="popup-title">Intelligent search</h6>
                        <p className="popup-paragraph">Our powerful search future will help you find saved sites in no time at all. 
                            No need to travel through all of your bookmarks.
                        </p>
